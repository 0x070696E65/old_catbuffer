...
public enum AccountStateFormatDto implements Serializer {
     ...
     */
     AccountStateFormatDto(final byte value) {
        this.value = value;
    }
     ...
     * @return Enum value.
     */
    public static AccountStateFormatDto rawValueOf(final byte value) {
     ...
     */
    public static AccountStateFormatDto loadFromBinary(final DataInputStream stream) {
        try {
