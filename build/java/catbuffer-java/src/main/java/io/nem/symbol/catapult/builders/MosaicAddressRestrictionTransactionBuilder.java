...
public class MosaicAddressRestrictionTransactionBuilder extends TransactionBuilder implements Serializer {
     ...
     */
    protected MosaicAddressRestrictionTransactionBuilder(DataInputStream stream) {
        super(stream);
        try {
     ...
     */
    public static MosaicAddressRestrictionTransactionBuilder loadFromBinary(DataInputStream stream) {
