...
namespace Symbol.Builders {
    ...
    */
    [Serializable]
    public class MosaicMetadataTransactionBuilder: TransactionBuilder {
        ...
        */
        internal MosaicMetadataTransactionBuilder(BinaryReader stream)
            : base(stream)
        {
            try {
        ...
        */
        public new static MosaicMetadataTransactionBuilder LoadFromBinary(BinaryReader stream) {
        ...
        */
        internal MosaicMetadataTransactionBuilder(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, AmountDto fee, TimestampDto deadline, UnresolvedAddressDto targetAddress, long scopedMetadataKey, UnresolvedMosaicIdDto targetMosaicId, short valueSizeDelta, byte[] value)
