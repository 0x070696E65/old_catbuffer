...
namespace Symbol.Builders {
    ...
    */
    ...
    public class EmbeddedMosaicGlobalRestrictionTransactionBuilder: EmbeddedTransactionBuilder {
        ...
        */
        internal EmbeddedMosaicGlobalRestrictionTransactionBuilder(KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, UnresolvedMosaicIdDto mosaicId, UnresolvedMosaicIdDto referenceMosaicId, long restrictionKey, long previousRestrictionValue, long newRestrictionValue, MosaicRestrictionTypeDto previousRestrictionType, MosaicRestrictionTypeDto newRestrictionType)
