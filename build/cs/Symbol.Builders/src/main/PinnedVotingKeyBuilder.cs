    ...
    */
    ...
    public class PinnedVotingKeyBuilder: ISerializer {
        ...
        */
        ...
        {
            try {
                votingKey = VotingKeyDto.LoadFromBinary(stream);
        ...
        */
        internal PinnedVotingKeyBuilder(VotingKeyDto votingKey, FinalizationEpochDto startEpoch, FinalizationEpochDto endEpoch)
        {
