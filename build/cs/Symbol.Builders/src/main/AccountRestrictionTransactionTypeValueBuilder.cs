...
namespace Symbol.Builders {
    ...
    */
    ...
    public class AccountRestrictionTransactionTypeValueBuilder: ISerializer {
        ...
        /* Restriction values. */
        public List<EntityTypeDto> restrictionValues;
        ...
        */
        internal AccountRestrictionTransactionTypeValueBuilder(BinaryReader stream)
        {
            try {
                ...
                restrictionValues = new List<EntityTypeDto>(){};
        ...
        */
        internal AccountRestrictionTransactionTypeValueBuilder(List<EntityTypeDto> restrictionValues)
        {
        ...
        */
        public int GetSize() {
            ...
            int restrictionValuesSize = 0;
            foreach (EntityTypeDto tt in restrictionValues)
            {
                restrictionValuesSize += tt.GetSize() + GeneratorUtils.GetPadding(restrictionValuesSize, 0);
            }
            size += restrictionValuesSize;
            return size;
        }
        ...
        */
        public byte[] Serialize() {
            ...
            foreach (var entity in restrictionValues)
            {
