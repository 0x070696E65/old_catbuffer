    ...
    public class TransferTransactionBodyBuilder: ISerializer {
        ...
        */
        internal TransferTransactionBodyBuilder(BinaryReader stream)
        {
            try {
                ...
                transferTransactionBody_Reserved1 = stream.ReadInt32();
                transferTransactionBody_Reserved2 = stream.ReadByte();
        ...
        */
        private int GetTransferTransactionBody_Reserved1() {
            return transferTransactionBody_Reserved1;
        }
        ...
        */
        private byte GetTransferTransactionBody_Reserved2() {
            return transferTransactionBody_Reserved2;
        }
        ...
        */
        public byte[] Serialize() {
            ...
            bw.Write(GetTransferTransactionBody_Reserved1());
            bw.Write(GetTransferTransactionBody_Reserved2());
            GeneratorUtils.WriteList(bw, mosaics, 0);
