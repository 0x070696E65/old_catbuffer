...
namespace Symbol.Builders {
    ...
    */
    ...
    public class EmbeddedVrfKeyLinkTransactionBuilder: EmbeddedTransactionBuilder {
        ...
        */
        internal EmbeddedVrfKeyLinkTransactionBuilder(KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, KeyDto linkedPublicKey, LinkActionDto linkAction)
