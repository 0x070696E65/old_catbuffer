...
namespace Symbol.Builders {
    ...
    */
    [Serializable]
    public class NemesisBlockHeaderBuilder: BlockHeaderBuilder {
        ...
        */
        internal NemesisBlockHeaderBuilder(BinaryReader stream)
            : base(stream)
        {
            try {
        ...
        */
        public new static NemesisBlockHeaderBuilder LoadFromBinary(BinaryReader stream) {
        ...
        */
        internal NemesisBlockHeaderBuilder(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, HeightDto height, TimestampDto timestamp, DifficultyDto difficulty, VrfProofBuilder generationHashProof, Hash256Dto previousBlockHash, Hash256Dto transactionsHash, Hash256Dto receiptsHash, Hash256Dto stateHash, AddressDto beneficiaryAddress, BlockFeeMultiplierDto feeMultiplier, int votingEligibleAccountsCount, long harvestingEligibleAccountsCount, AmountDto totalVotingBalance, Hash256Dto previousImportanceBlockHash)
