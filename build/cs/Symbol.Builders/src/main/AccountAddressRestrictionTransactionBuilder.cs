...
namespace Symbol.Builders {
    ...
    */
    [Serializable]
    public class AccountAddressRestrictionTransactionBuilder: TransactionBuilder {
        ...
        */
        internal AccountAddressRestrictionTransactionBuilder(BinaryReader stream)
            : base(stream)
        {
            try {
        ...
        */
        public new static AccountAddressRestrictionTransactionBuilder LoadFromBinary(BinaryReader stream) {
        ...
        */
        internal AccountAddressRestrictionTransactionBuilder(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, AmountDto fee, TimestampDto deadline, List<AccountRestrictionFlagsDto> restrictionFlags, List<UnresolvedAddressDto> restrictionAdditions, List<UnresolvedAddressDto> restrictionDeletions)
        ...
        * @return Instance of AccountAddressRestrictionTransactionBuilder.
        */
        public static  AccountAddressRestrictionTransactionBuilder Create(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, AmountDto fee, TimestampDto deadline, List<AccountRestrictionFlagsDto> restrictionFlags, List<UnresolvedAddressDto> restrictionAdditions, List<UnresolvedAddressDto> restrictionDeletions) {
