...
namespace Symbol.Builders {
    ...
    */
    ...
    public class AggregateCompleteTransactionBuilder: TransactionBuilder {
        ...
        */
        internal AggregateCompleteTransactionBuilder(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, AmountDto fee, TimestampDto deadline, Hash256Dto transactionsHash, List<EmbeddedTransactionBuilder> transactions, List<CosignatureBuilder> cosignatures)
