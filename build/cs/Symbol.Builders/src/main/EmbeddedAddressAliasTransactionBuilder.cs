...
namespace Symbol.Builders {
    ...
    */
    ...
    public class EmbeddedAddressAliasTransactionBuilder: EmbeddedTransactionBuilder {
        ...
        */
        internal EmbeddedAddressAliasTransactionBuilder(KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, NamespaceIdDto namespaceId, AddressDto address, AliasActionDto aliasAction)
