...
namespace Symbol.Builders {
    ...
    */
    ...
    public class EmbeddedMosaicAliasTransactionBuilder: EmbeddedTransactionBuilder {
        ...
        */
        internal EmbeddedMosaicAliasTransactionBuilder(KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, NamespaceIdDto namespaceId, MosaicIdDto mosaicId, AliasActionDto aliasAction)
