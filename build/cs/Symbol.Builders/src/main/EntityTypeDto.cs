...
namespace Symbol.Builders {
    ...
    public static class EntityTypeDtoExtensions
    {
        /* Enum value. */
        private static short value(this EntityTypeDto self) {
            return (short)self;
        }
        ...
        * @return Enum value.
        */
        public static EntityTypeDto RawValueOf(this EntityTypeDto self, short value) {
            foreach (EntityTypeDto current in Enum.GetValues(typeof(EntityTypeDto))) {
                if (value == (current.value()) {
                    return current;
                }
            }
            throw new Exception(value + " was not a backing value for EntityTypeDto.");
        }
        ...
        */
        public static int GetSize(this EntityTypeDto type)
        {
            return 2;
        }
        ...
        */
        public static EntityTypeDto LoadFromBinary(this EntityTypeDto self, BinaryReader stream) {
            try {
        ...
        */
        public static byte[] Serialize(this EntityTypeDto self) {
