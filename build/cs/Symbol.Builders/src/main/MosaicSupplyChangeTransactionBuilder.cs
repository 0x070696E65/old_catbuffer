...
namespace Symbol.Builders {
    ...
    */
    ...
    public class MosaicSupplyChangeTransactionBuilder: TransactionBuilder {
        ...
        */
        internal MosaicSupplyChangeTransactionBuilder(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, AmountDto fee, TimestampDto deadline, UnresolvedMosaicIdDto mosaicId, AmountDto delta, MosaicSupplyChangeActionDto action)
