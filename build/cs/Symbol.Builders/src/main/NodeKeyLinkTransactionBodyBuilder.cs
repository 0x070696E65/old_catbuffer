...
namespace Symbol.Builders {
    ...
    */
    [Serializable]
    public class NodeKeyLinkTransactionBodyBuilder: ISerializer {
        ...
        */
        internal NodeKeyLinkTransactionBodyBuilder(BinaryReader stream)
        {
            try {
        ...
        */
        public static NodeKeyLinkTransactionBodyBuilder LoadFromBinary(BinaryReader stream) {
        ...
        */
        internal NodeKeyLinkTransactionBodyBuilder(KeyDto linkedPublicKey, LinkActionDto linkAction)
        {
