...
namespace Symbol.Builders {
    ...
    */
    ...
    public class VotingKeyLinkTransactionBuilder: TransactionBuilder {
        ...
        */
        internal VotingKeyLinkTransactionBuilder(SignatureDto signature, KeyDto signerPublicKey, byte version, NetworkTypeDto network, EntityTypeDto type, AmountDto fee, TimestampDto deadline, VotingKeyDto linkedPublicKey, FinalizationEpochDto startEpoch, FinalizationEpochDto endEpoch, LinkActionDto linkAction)
