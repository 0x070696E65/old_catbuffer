...
/**
 *  Interface to create instances of NamespaceMetadataTransactionBuilder.
 */
...
export class NamespaceMetadataTransactionBuilder extends TransactionBuilder implements Serializer {
    ...
    public static readonly ENTITY_TYPE = EntityTypeDto.NAMESPACE_METADATA_TRANSACTION;
    ...
    public constructor({
        ...
        valueSizeDelta,
        value,
    }: NamespaceMetadataTransactionBuilderParams) {
        ...
        if (version !== NamespaceMetadataTransactionBuilder.VERSION)
            throw new Error(
                'The provided version value ' + version + ' is invalid. Expected value is ' + NamespaceMetadataTransactionBuilder.VERSION,
            );
        if (type !== NamespaceMetadataTransactionBuilder.ENTITY_TYPE)
            throw new Error(
                'The provided type value ' + type + ' is invalid. Expected value is ' + NamespaceMetadataTransactionBuilder.ENTITY_TYPE,
            );
    }
