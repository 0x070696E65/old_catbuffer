...
/**
 *  Interface to create instances of VrfKeyLinkTransactionBodyBuilder.
 */
 ...
 **/
export class VrfKeyLinkTransactionBodyBuilder implements Serializer {
    /** Linked public key. **/
     ...
     */
    public constructor({ linkedPublicKey, linkAction }: VrfKeyLinkTransactionBodyBuilderParams) {
    ...
    public static loadFromBinary(payload: Uint8Array): VrfKeyLinkTransactionBodyBuilder {
        ...
        return new VrfKeyLinkTransactionBodyBuilder({ linkedPublicKey: linkedPublicKey, linkAction: linkAction });
    }
     ...
     */
    public static createVrfKeyLinkTransactionBodyBuilder(
        linkedPublicKey: KeyDto,
        linkAction: LinkActionDto,
    ): VrfKeyLinkTransactionBodyBuilder {
        return new VrfKeyLinkTransactionBodyBuilder({ linkedPublicKey: linkedPublicKey, linkAction: linkAction });
    }
