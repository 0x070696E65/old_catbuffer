...
/**
 *  Interface to create instances of AccountKeyLinkTransactionBodyBuilder.
 */
 ...
 **/
export class AccountKeyLinkTransactionBodyBuilder implements Serializer {
    /** Linked public key. **/
     ...
     */
    public constructor({ linkedPublicKey, linkAction }: AccountKeyLinkTransactionBodyBuilderParams) {
     ...
     */
    public static createAccountKeyLinkTransactionBodyBuilder(
        linkedPublicKey: KeyDto,
        linkAction: LinkActionDto,
    ): AccountKeyLinkTransactionBodyBuilder {
        return new AccountKeyLinkTransactionBodyBuilder({ linkedPublicKey: linkedPublicKey, linkAction: linkAction });
    }
