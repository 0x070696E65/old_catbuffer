...
export class DifficultyDto implements Serializer {
    ...
    public static loadFromBinary(payload: Uint8Array): DifficultyDto {
        const difficulty = GeneratorUtils.bufferToBigInt(Uint8Array.from(payload));
        return new DifficultyDto(difficulty);
    }

    /**
     * Creates an 'empty' instance of DifficultyDto
     *
     * @return DifficultyDto instance.
     */
    public static createEmpty(): DifficultyDto {
    ...
    public serialize(): Uint8Array {
        return GeneratorUtils.bigIntToBuffer(this.difficulty);
    }
}
