...
/**
 *  Interface to create instances of MosaicExpiryReceiptBuilder.
 */
...
export class MosaicExpiryReceiptBuilder extends ReceiptBuilder implements Serializer {
    /** Expiring mosaic id. **/
    public readonly artifactId: MosaicIdDto;
     ...
     */
    public constructor({ version, type, artifactId }: MosaicExpiryReceiptBuilderParams) {
        super({ version, type });
