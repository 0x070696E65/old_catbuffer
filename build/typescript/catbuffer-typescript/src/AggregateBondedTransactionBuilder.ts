...
/**
 *  Interface to create instances of AggregateBondedTransactionBuilder.
 */
 ...
 **/
export class AggregateBondedTransactionBuilder extends TransactionBuilder implements Serializer {
    public static readonly VERSION = 1;
    public static readonly ENTITY_TYPE = EntityTypeDto.AGGREGATE_BONDED_TRANSACTION;
    ...
    public constructor({
        ...
        transactions,
        cosignatures,
    }: AggregateBondedTransactionBuilderParams) {
        ...
        if (version !== AggregateBondedTransactionBuilder.VERSION)
            throw new Error(
                'The provided version value ' + version + ' is invalid. Expected value is ' + AggregateBondedTransactionBuilder.VERSION,
            );
        if (type !== AggregateBondedTransactionBuilder.ENTITY_TYPE)
            throw new Error(
                'The provided type value ' + type + ' is invalid. Expected value is ' + AggregateBondedTransactionBuilder.ENTITY_TYPE,
            );
    }
     ...
     */
    public static createAggregateBondedTransactionBuilder(
