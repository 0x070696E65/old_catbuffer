...
/**
 *  Interface to create instances of AccountMetadataTransactionBodyBuilder.
 */
 ...
 **/
export class AccountMetadataTransactionBodyBuilder implements Serializer {
    /** Metadata target address. **/
     ...
     */
    public constructor({ targetAddress, scopedMetadataKey, valueSizeDelta, value }: AccountMetadataTransactionBodyBuilderParams) {
     ...
     */
    public static createAccountMetadataTransactionBodyBuilder(
        targetAddress: UnresolvedAddressDto,
        scopedMetadataKey: bigint,
        valueSizeDelta: number,
        value: Uint8Array,
