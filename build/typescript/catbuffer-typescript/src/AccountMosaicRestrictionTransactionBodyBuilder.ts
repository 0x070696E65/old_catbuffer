...
/**
 *  Interface to create instances of AccountMosaicRestrictionTransactionBodyBuilder.
 */
...
export class AccountMosaicRestrictionTransactionBodyBuilder implements Serializer {
    ...
    /** Account restriction additions. **/
    public readonly restrictionAdditions: UnresolvedMosaicIdDto[];

    /** Account restriction deletions. **/
    public readonly restrictionDeletions: UnresolvedMosaicIdDto[];
    ...
    }: AccountMosaicRestrictionTransactionBodyBuilderParams) {
    ...
    public static loadFromBinary(payload: Uint8Array): AccountMosaicRestrictionTransactionBodyBuilder {
        ...
        return new AccountMosaicRestrictionTransactionBodyBuilder({
