...
/**
 *  Interface to create instances of EmbeddedAccountMetadataTransactionBuilder.
 */
...
export class EmbeddedAccountMetadataTransactionBuilder extends EmbeddedTransactionBuilder implements Serializer {
    ...
    public static readonly ENTITY_TYPE = EntityTypeDto.EMBEDDED_ACCOUNT_METADATA_TRANSACTION;
    ...
    public constructor({
        ...
        valueSizeDelta,
        value,
    }: EmbeddedAccountMetadataTransactionBuilderParams) {
