...
export class ImportanceDto implements Serializer {
    ...
    public static loadFromBinary(payload: Uint8Array): ImportanceDto {
        const importance = GeneratorUtils.bufferToBigInt(Uint8Array.from(payload));
        return new ImportanceDto(importance);
    }

    /**
     * Creates an 'empty' instance of ImportanceDto
     *
     * @return ImportanceDto instance.
     */
    public static createEmpty(): ImportanceDto {
    ...
    public serialize(): Uint8Array {
        return GeneratorUtils.bigIntToBuffer(this.importance);
    }
}
