...
class NamespaceMetadataTransactionBodyBuilder:
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> NamespaceMetadataTransactionBodyBuilder:
        ...
        bytes_ = bytes_[8:]
        target_namespace_id_ = NamespaceIdDto.load_from_binary(bytes_)  # kind:CUSTOM1_byte
        target_namespace_id = target_namespace_id_.namespaceId
        bytes_ = bytes_[target_namespace_id_.get_size():]
    ...
    def get_size(self) -> int:
        ...
        size += NamespaceIdDto(self.target_namespace_id).get_size()
    ...
    def serialize(self) -> bytes:
        ...
        bytes_ = GeneratorUtils.concat_typed_arrays(bytes_, NamespaceIdDto(self.target_namespace_id).serialize())  # kind:CUSTOM
    ...
    def __str__(self):
        ...
        result += '{:24s} : {}\n'.format('target_namespace_id', to_hex_string(NamespaceIdDto(self.target_namespace_id).serialize()))
