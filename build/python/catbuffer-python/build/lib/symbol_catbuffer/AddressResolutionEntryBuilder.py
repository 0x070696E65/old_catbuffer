...
class AddressResolutionEntryBuilder:
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> AddressResolutionEntryBuilder:
        ...
        resolved = AddressDto.load_from_binary(bytes_)  # kind:CUSTOM1
    ...
    def get_resolved(self) -> AddressDto:
        """Gets resolved value.
        Returns:
            Resolved value.
        """
